...
5. physical_and_environmental: ALL tasks requiring a human body in a physical space — INCLUDING cognitive work inseparable from physical presence. A surgeon's intraoperative decisions count here because you can't automate the judgment without also automating the hands. A firefighter's scene assessment counts here because it requires being IN the burning building. Also: manual repairs, patient physical care, construction, equipment operation, emergency response, cooking, physical examinations, athletic performance.

CRITICAL EXCEPTION — Driving & Vehicle Operation: Do NOT classify the act of driving a vehicle as physical_and_environmental. Autonomous vehicles (Tesla FSD, Waymo, autonomous trucking) are actively automating driving — it is AI-vulnerable work, not AI-resistant. For driving-heavy jobs, classify: route-following and navigation → routine_data_text, traffic rules and situational awareness → structured_rule_analysis. Only truly manual non-driving tasks (loading/unloading cargo, vehicle inspection, passenger physical assistance) remain physical_and_environmental.
...
- Example — Truck Driver: routine_data_text: 44 (driving/route-following, GPS navigation, fuel stops, logbook entries, compliance paperwork), structured_rule_analysis: 16 (traffic rules, DOT regulations, situational driving decisions, load weight compliance), content_creation: 1 (delivery reports), novel_problem_solving: 4 (unexpected road conditions, route improvisation), physical_and_environmental: 27 (loading/unloading cargo, pre-trip vehicle inspection, coupling trailers, tire checks), interpersonal_emotional: 8 (dispatcher coordination, customer interaction at delivery). Sum = 100.
