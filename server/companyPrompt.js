...

{
  ...
  "summary": "<string: 2 sentences. The narrative arc for this company in an AI world. What's the story? Where are they strong, where are they exposed, and what's the likely trajectory?>",
  ...
  "dimensions": {
    "product_disruption": {
      ...
      "analysis": "<string: 2 sentences, max 50 words. Can AI replicate or replace what this company sells? Be specific about WHICH capabilities are threatened and which aren't. Don't anchor to what AI can do today — project forward 2-3 years based on current trajectory. Consider: could a small team with AI tools build a credible competitor to this product?>"
    },
    "headcount_vulnerability": {
      "score_now": <number 0-100>,
      "score_2028": <number 0-100>,
      "label": "<string: 3-6 word status>",
      "analysis": "<string: 2 sentences, max 50 words. How much of this company's workforce could be reduced by AI within 2-3 years? Be specific about which functions are most exposed: sales/SDR teams, customer support, engineering, marketing/content, operations, finance, legal. Consider the company's current size — a 300-person lean company has different headcount risk than a 73,000-person bloated one.>"
    },
    "moat_erosion": {
      "score_now": <number 0-100>,
      "score_2028": <number 0-100>,
      "label": "<string: 3-6 word status>",
      "analysis": "<string: 2 sentences, max 50 words. What has historically protected this company? Assess each moat specifically: proprietary data, technical complexity, switching costs, network effects, regulatory barriers, brand trust, physical infrastructure, ecosystem lock-in. Which moats are holding? Which are crumbling? AI doesn't just compete with products — it lowers the barrier to building competitors, which erodes moats indirectly.>"
    },
    "business_model_risk": {
      "score_now": <number 0-100>,
      "score_2028": <number 0-100>,
      "label": "<string: 3-6 word status>",
      "analysis": "<string: 2 sentences, max 50 words. Is the revenue model threatened? Per-seat SaaS pricing is ground zero for AI disruption (fewer humans = fewer seats). Per-usage, per-endpoint, per-transaction, and platform/marketplace models are more resilient. Advertising models face mixed effects. Services/consulting models are highly exposed. Be specific about THIS company's pricing structure and how AI changes their customers' willingness to pay.>"
    },
    "market_viability": {
      "score_now": <number 0-100>,
      "score_2028": <number 0-100>,
      "label": "<string: 3-6 word status>",
      "analysis": "<string: 2 sentences, max 50 words. Is the overall market growing, stable, or shrinking due to AI? A company can execute perfectly and still be cooked if the market itself is disappearing. Distinguish between the NEED persisting (people always need to file taxes) and the MARKET persisting (the market for paid tax prep software may not). Also consider: does AI expand this market or contract it?>"
    }
  },

  "what_would_kill_it": "<string: 2 sentences. The specific, realistic scenario that would be existential. Be concrete: name the type of competitor, the specific product capability, the price point, the timeline. Not 'AI gets better' but 'A 10-person startup builds X that does Y at Z% of the cost, targeting their most vulnerable customer segment.'>",

  "what_keeps_it_alive": "<string: 2 sentences. The specific, realistic advantages that protect this company. Be honest about durability — a moat that lasts 2 years is different from one that lasts 10. Distinguish between 'safe because AI can't do this' and 'safe because switching costs buy time even though AI can do this.'>",

  "ai_adaptation_signals": "<string: 1-2 sentences. What evidence exists that this company is or isn't adapting? AI product launches, AI hiring, executive statements about AI strategy, partnerships with AI companies. If you don't have specific knowledge, say what signals you'd look for rather than guessing.>",
...
CRITICAL RULES:
- Respect the sentence limits in the schema. Every field is displayed in a small card on a phone screen — tight and specific beats long and thorough. Total response should be under 1,000 tokens.
